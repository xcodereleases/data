...
let xcodes7: Array<Xcode> = [
    ...
    Xcode(version: V("7D1014", "7.3.1"),
          ...
          download: "https://download.developer.apple.com/Developer_Tools/Xcode_7.3.1/Xcode_7.3.1.dmg"),
    ...
    Xcode(version: V("7D175", "7.3"),
          ...
          download: "https://download.developer.apple.com/Developer_Tools/Xcode_7.3/Xcode_7.3.dmg"),
    ...
    Xcode(version: V("7C1002", "7.2.1"),
          ...
          download: "https://download.developer.apple.com/Developer_Tools/Xcode_7.2.1/Xcode_7.2.1.dmg"),
    ...
    Xcode(version: V("7C68", "7.2"),
          ...
          compilers: Compilers(llvm: V("3.7.0"), clang: V("700.1.81", "7.0.2"), swift: V("700.1.101.15", "2.1.1")),
          download: "https://download.developer.apple.com/Developer_Tools/Xcode_7.2/Xcode_7.2.dmg"),

    Xcode(version: V("7B1005", "7.1.1"),
          date: (2015, 11, 05),
          requires: "10.10.5",
          sdks: SDKs(macOS: V("15A278"), iOS: V("13B137"), watchOS: V("13S343"), tvOS: V("13T393")),
          download: "https://download.developer.apple.com/Developer_Tools/Xcode_7.1.1/Xcode_7.1.1.dmg"),
    ...
    Xcode(version: V("7B91b", "7.1"),
          ...
          download: "https://download.developer.apple.com/Developer_Tools/Xcode_7.1/Xcode_7.1.dmg"),
    ...
    Xcode(version: V("7A1001", "7.0.1"),
          ...
          download: "https://download.developer.apple.com/Developer_Tools/Xcode_7.0.1/Xcode_7.0.1.dmg"),
    ...
    Xcode(version: V("7A220", "7.0"),
          ...
          sdks: SDKs(macOS: V("15A278"), iOS: V("13A340"), watchOS: V("13S343")),
          compilers: Compilers(llvm: V("3.7.0"), clang: V("700.0.72", "7.0.0"), swift: V("700.0.59", "2.0")),
          download: "https://download.developer.apple.com/Developer_Tools/Xcode_7/Xcode_7.dmg"),
