...
let xcodes4: Array<Xcode> = [
    ...
    Xcode(version: V("4H1503", "4.6.3"),
          ...
          download: "https://download.developer.apple.com/Developer_Tools/xcode_4.6.3/xcode4630916281a.dmg"),
    ...
    Xcode(version: V("4H1003", "4.6.2"),
          ...
          sdks: SDKs(macOS: [V("11E52"), V("12D75")], iOS: V("10B141")),
          compilers: Compilers(llvm_gcc: V("5658", "4.2"), llvm: V("2336.11.00"), clang: V("425.0.28", "4.1")),
          download: "https://download.developer.apple.com/Developer_Tools/xcode_4.6.2/xcode4620419895a.dmg"),
    ...
    Xcode(version: V("4H512", "4.6.1"),
          ...
          download: "https://download.developer.apple.com/Developer_Tools/xcode_4.6.1/xcode4610419628a.dmg"),
    ...
    Xcode(version: V("4H127", "4.6"),
          ...
          download: "https://download.developer.apple.com/Developer_Tools/xcode_4.6/xcode460417218a.dmg",
    ...
    Xcode(version: V("4G2008a", "4.5.2"),
          ...
          download: "https://download.developer.apple.com/Developer_Tools/xcode_4.5.2/xcode4520418508a.dmg",
    ...
    Xcode(version: V("4G1004", "4.5.1"),
          ...
          sdks: SDKs(macOS: [V("11E52"), V("12C237")], iOS: V("10A403")),
          compilers: Compilers(llvm_gcc: V("5658", "4.2"), llvm: V("2336.11.00"), clang: V("421.11.66", "4.1")),
          download: "https://download.developer.apple.com/Developer_Tools/xcode_4.5.1/xcode4510417539a.dmg",
    ...
    Xcode(version: V("4G182", "4.5"),
          ...
          download: "https://download.developer.apple.com/Developer_Tools/xcode_4.5/xcode_4.5.dmg"),
    ...
    Xcode(version: V("4F1003", "4.4.1"),
          ...
          download: "https://download.developer.apple.com/Developer_Tools/xcode_4.4.1/xcode_4.4.1_6938145.dmg"),
    ...
    Xcode(version: V("4E3002", "4.3.3"),
          ...
          download: "https://download.developer.apple.com/Developer_Tools/xcode_4.3.3_for_lion/xcode_4.3.3_for_lion.dmg"),
    ...
    Xcode(version: V("4E2002", "4.3.2"),
          ...
          download: "https://download.developer.apple.com/Developer_Tools/xcode_4.3.2/xcode_432_lion.dmg"),
    ...
    Xcode(version: V("4F134", "4.4"),
          ...
          download: "https://download.developer.apple.com/Developer_Tools/xcode_4.4_21362/xcode446938108a.dmg",
    ...
    Xcode(version: V("4E1019", "4.3.1"),
          ...
          download: "https://download.developer.apple.com/Developer_Tools/xcode_4.3.1_for_lion_21267/xcode_431_lion.dmg"),
    ...
    Xcode(version: V("4E109", "4.3"),
          ...
          download: "https://download.developer.apple.com/Developer_Tools/xcode_4.3_for_lion_21266/xcode_43_lion.dmg"),
    ...
    Xcode(version: V("4D502", "4.2.1"),
          ...
          requires: "10.7",
          sdks: SDKs(iOS: V("9A334")),
          download: "https://download.developer.apple.com/Developer_Tools/xcode_4.2.1_for_lion_21265/installxcode_421_lion.dmg"),
    ...
    Xcode(version: V("4D199", "4.2"),
          ...
          download: "https://download.developer.apple.com/Developer_Tools/xcode_4.2_for_lion_21264/installxcode_42_lion.dmg"),
    ...
    Xcode(version: V("4C199", "4.2"),
          ...
          sdks: SDKs(iOS: V("9A334")),
          compilers: Compilers(llvm_gcc: V("5658", "4.2"), llvm: V("2336.1.00"), clang: V("211.10.1", "3.0")),
          download: "https://download.developer.apple.com/Developer_Tools/xcode_4.2_for_snow_leopard/xcode_4.2_for_snow_leopard.dmg",
    ...
    Xcode(version: V("4B110f", "4.1"),
          ...
          download: "https://download.developer.apple.com/Developer_Tools/xcode_4.1_for_snow_leopard_21110/xcode_4.1_for_snow_leopard.dmg",
    ...
    Xcode(version: V("4B110i", "4.1"),
          ...
          requires: "10.7",
          compilers: Compilers(gcc: V("5666", "4.2"), llvm_gcc: V("5658", "4.2"), llvm: V("2335.15.00"), clang: V("163.7.1", "2.1")),
          download: "https://download.developer.apple.com/Developer_Tools/xcode_4.1_for_lion_21263/installxcode_41_lion.dmg"),
    ...
    Xcode(version: V("4A2002a", "4.0.2"),
          ...
          download: "https://download.developer.apple.com/Developer_Tools/xcode_4.0.2_and_ios_sdk_4.3/xcode_4.0.2_and_ios_sdk_4.3.dmg",
    ...
    Xcode(version: V("4A1006", "4.0.1"),
          date: (2011, 03, 23),
          requires: "10.6.8",
          download: "https://download.developer.apple.com/Developer_Tools/xcode_4.0.1_and_ios_sdk_4.3/xcode_4.0.1_and_ios_sdk_4.3.dmg",
    ...
    Xcode(version: V("4A304a", "4.0"),
          ...
          requires: "10.6.8",
          compilers: Compilers(gcc: [V("5494", "4.0"), V("5666", "4.2")], llvm_gcc: [V("5658", "4.2")], llvm: [V("2335.9")], clang: [V("137", "2.0")], swift:  nil),
          download: "https://download.developer.apple.com/Developer_Tools/xcode_4_and_ios_sdk_4.3__final/xcode_4_and_ios_sdk_4.3__final.dmg",
