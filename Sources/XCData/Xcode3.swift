...
let xcodes3: Array<Xcode> = [
    ...
    Xcode(version: V("10M25xx", "3.2.6", .release),
          date: (2011, 03, 06),
          requires: "10.6.4",
          ...
          links: [
            Link(xcode: "https://download.developer.apple.com/Developer_Tools/xcode_3.2.6_and_ios_sdk_4.3__final/xcode_3.2.6_and_ios_sdk_4.3.dmg",
                 checksum: .sha1("a63e76e32f1c3d201321165e8361ad0400f39f7d")),
    ...
    Xcode(version: V("10M2423", "3.2.5", .release),
          date: (2010, 11, 18),
          requires: "10.6.4",
    ...
    Xcode(version: V("10M2309", "3.2.4", .release),
          ...
          links: [
            Link(xcode: "https://download.developer.apple.com/ios/ios_sdk_4.1__final/xcode_3.2.4_and_ios_sdk_4.1.dmg",
                 checksum: .sha1("970cc01f0edc22789f963560879069d6b94b37d4")),
            Link(notes: "https://download.developer.apple.com/ios/ios_sdk_4.1__final/finalv2_about_xcode_3.2.4_and_ios_sdk_4.1.pdf")
          ]),
    
    Xcode(version: V("10M2262", "3.2.3", .release),
          date: (2010, 08, 10),
          requires: "10.6.2",
          sdks: [.iOS(V(number: "3.2")), .iOS(V(number: "4.0.2"))],
          compilers: [.gcc(V("5494", "4.0")), .gcc(V("5664", "4.2")), .llvm_gcc(V("5658", "4.2")), .llvm(V("2326.10")), .clang(V("60", "1.5"))],
          links: [
            Link(xcode: "https://download.developer.apple.com/ios/ios_sdk_4.0.2__final/xcode_3.2.3_and_ios_sdk_4.0.2.dmg", checksum: .sha1("643c30f02575ee256a7ee1d15b5207602bb6d80d"))
          ]),
    ...
    Xcode(version: V("10M2154", "3.2.2", .release),
          ...
          links: [
            Link(xcode: "https://download.developer.apple.com/Developer_Tools/xcode_3.2.2_developer_tools_beta_20728/xcode322_2148_developerdvd.dmg",
                 checksum: .sha1("7a5e2fa7ee2a93c933c3ecdddafc68c5ae5299e0")),
    ...
    Xcode(version: V("10M2020", "3.2.1", .release),
          date: (2009, 10, 07),
          requires: "10.6",
    ...
    Xcode(version: V("9M2517", "3.1.1", .release),
          ...
          links: [
            Link(xcode: "https://download.developer.apple.com/Developer_Tools/xcode_3.1.1_developer_tools_preview_1/xcode311_9m2517_developerdvd.dmg",
                 checksum: .sha1("27f436c179cd9ff1d263e6507a0f5aeb3cf4e3ac")),
    ...
    Xcode(version: V("9A581", "3.0", .release),
          ...
          links: [
            Link(xcode: "https://download.developer.apple.com/Developer_Tools/xcode_3.0/xcode_3.0.dmg",
                 checksum: .sha1("fc212a810cd72fb224199b4f5977beb377042fad")),
